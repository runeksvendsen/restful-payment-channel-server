...
For distributions without the `haskell-stack` package available, stack (the build tool) can be easily with a single command. See [https://docs.haskellstack.org/en/stable/README/#how-to-install](https://docs.haskellstack.org/en/stable/README/#how-to-install) for more information.
